...
<head>
  ...
  <link href="https://netdna.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" rel="stylesheet" />
    ...
    <div class="view parallax" style="background-image: url({{url('public/images/audience.jpg')}}'); background-repeat: no-repeat; background-size: cover;">
                            ...
                            <div class="parallax">
                                <center>
                                        <div class=" col-md-12 mb-4 wow zoomIn" data-wow-duration="2s" data-wow-duration="3s;" style="padding: 20px; color: white;";>
                                                ...
                                                <!-- CTA -->
                                                <a target="_blank" href="#" class="btn" style="background: #1a1aff; border-radius: 20px; color: white;">
                                                    REGISTER Now
                      ...
                      <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-1">
                                <center>
                                            <img class="img-circle wow zoomIn" data-wow-duration="2s" data-wow-duration="3s;" src="{{url('public/images/excel.jpeg')}}" style="border-radius: 50px;" />
                                          </center>
                                      ...
                                      <div class="col-md-4 mb-1">
                                          <center>
                                                      <img class="img-circle wow zoomIn" data-wow-duration="2s" data-wow-duration="3s;" src="{{url('public/images/mundus.jpeg')}}" style="border-radius: 50px;" />
                                                    </center>
                                                ...
                                                <div class="col-md-4 mb-1">
                                                    <center>
                                                                <img class="img-circle wow zoomIn" data-wow-duration="2s" data-wow-duration="3s;" src="{{url('public/images/chukusu.jpeg')}}" style="border-radius: 50px;" />
                                                              </center>
...
<center>
        <button class="btn" id="myBtn" style="background: #1a1aff; border-radius: 10px; color: white; font-family: verdana;">
                I want to Register
                <i class="fas fa-user-friends ml-2"></i> </button>
