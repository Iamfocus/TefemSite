...
<form class="text-center border border-light p-5"  method='Post' action="signup.php">
    ...
    <div class="form-row ">
        <div class="col-md-6 ">
            <!-- First name -->
          <input type="email" id="" name="email" class="form-control mb-4" placeholder="E-mail" required>
        </div>
        <div class="col-md-6 mb-4">
            <!-- Last name -->
            <input type="number" id="" name="phone_number" class="form-control" placeholder="phone number" required>
        </div>
    </div>
    ...
    <div class="form-row mb-4">
        <div class="col-md-6 mb-4">
            <!-- First name -->
            <input type="text" id="" name="marital_status" class="form-control" placeholder="Marital status" required>
        </div>
        <div class="col-md-6">
            <!-- Last name -->
